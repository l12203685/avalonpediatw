    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-xs text-gray-300">{team === 'good' ? '忠誠' : '欺騙'}</span>
        </div>
        ...
        >
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className={`text-sm font-bold ${colors.text}`}>勝利條件</p>
            </div>
          ...
          {abilities.length > 2 && (
            <div className="mb-4">
              <p className={`text-sm font-bold ${colors.text} mb-2`}>所有能力</p>
          ...
          {/* Tips */}
          <div>
            <p className={`text-sm font-bold ${colors.text} mb-2`}>💡 技巧</p>
            <ul className="space-y-1 ml-2">
              {tips.map((tip, idx) => (
                <motion.li
                  key={idx}
