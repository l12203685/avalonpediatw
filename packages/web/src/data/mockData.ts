...
export const MOCK_PLAYERS: Player[] = [
  ...
  { id: 'p4', name: '莫甘娜', avatar: undefined, role: 'morgana', team: 'evil', status: 'active', createdAt: Date.now() - 86400000 },
  { id: 'p5', name: '派西維爾', avatar: undefined, role: 'percival', team: 'good', status: 'active', createdAt: Date.now() - 86400000 },
