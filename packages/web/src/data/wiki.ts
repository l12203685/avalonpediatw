...
- 每個人玩法不一樣，但請記住你終究是紅方，不要演好人過頭`,
  ...
  {
    id: 'roles-minion',
    title: '莫德雷德的爪牙 (Minion of Mordred)',
    category: 'roles',
    excerpt: '邪惡陣營的普通成員。無特殊能力，但與其他壞人相認，是紅方的基本戰力。',
    content: `# 莫德雷德的爪牙（Minion of Mordred）
...
> 本頁為擴展條目初版，歡迎社群補充細節。`,
  ...
  {
    id: 'roles-lancelot-good',
    title: '好蘭斯洛特 (Good Lancelot)',
    category: 'roles',
    excerpt: '擴展版角色。遊戲過程中陣營可能翻轉為邪惡方，增加變數與不確定性。',
    content: `# 好蘭斯洛特（Good Lancelot）
...
## 角色特性 (Role Traits)
- 初始為善良陣營
- 可能因「蘭斯洛特卡」而與邪惡蘭斯洛特互換陣營
- 無夜晚資訊

## 勝利條件
- 當前所屬陣營勝利條件（善或惡視翻轉狀態而定）
...
> 本頁為擴展條目初版，歡迎社群補充細節。`,
    tags: ['角色', '好陣營', '蘭斯洛特', 'stub'],
    author: 'community',
    updatedAt: new Date('2026-04-16'),
    views: 0,
  },
  {
    id: 'roles-lancelot-evil',
    title: '壞蘭斯洛特 (Evil Lancelot)',
    category: 'roles',
    excerpt: '擴展版角色。初始為邪惡方，但陣營可能翻轉為善良方。',
    content: `# 壞蘭斯洛特（Evil Lancelot）
...
> 本頁為擴展條目初版，歡迎社群補充細節。`,
  ...
  },
  {
    ...
    title: '賈拉哈德 (Galahad)',
    category: 'roles',
    excerpt: '擴展版善良能力者。通常作為梅林資訊的部分承接者，機制依版本而異。',
    content: `# 賈拉哈德（Galahad）
...
> 本頁為擴展條目初版，歡迎社群補充細節。`,
    tags: ['角色', '好陣營', '賈拉哈德', 'stub'],
    author: 'community',
    updatedAt: new Date('2026-04-16'),
    views: 0,
  },
  {
    id: 'roles-troublemaker',
    title: '搗蛋鬼 (Troublemaker)',
    category: 'roles',
    excerpt: '擴展版中性／邪惡干擾角色，以混淆資訊為主。具體機制依變體而異。',
    content: `# 搗蛋鬼（Troublemaker）
...
> 本頁為擴展條目初版，歡迎社群補充細節。`,
  ...
  {
    id: 'roles-lady-of-the-lake',
    title: '湖中女神 (Lady of the Lake)',
    category: 'roles',
    excerpt: '嚴格來說是道具卡而非角色，但常被當作特殊身份討論：持有者可在任務後查驗他人陣營。',
    content: `# 湖中女神（Lady of the Lake）

## 性質
道具卡（非嚴格意義上的角色），但因對局面影響重大，列於角色指南。

## 機制
- 第 2、3、4 次任務結束後，持有者可指定一位尚未被查驗過的玩家查看其善惡陣營
- 查完後將湖中女神卡交給被查驗者
- 第一任湖中女神由最後一位被選進 1 票任務的玩家持有（依版本規則）

## 策略要點
- 湖中女神是藍方重要的驗證工具
- 紅方持有湖中女神時可以「假報」對方陣營以誤導場面
- 誰會拿到湖中女神常影響派票與投票策略

> 本頁為擴展條目初版，歡迎社群補充細節。`,
    tags: ['角色', '道具', '湖中女神', 'stub'],
    author: 'community',
    updatedAt: new Date('2026-04-16'),
    views: 0,
  },
